...
public class ScrollingLinearLayoutManager extends LinearLayoutManager {
  ...
  public ScrollingLinearLayoutManager(
      Context context, int orientation, boolean reverseLayout, int duration) {
  ...
  private class SmoothScroller extends LinearSmoothScroller {
    ...
    public SmoothScroller(Context context, int distanceInPixels, int duration) {
      ...
      this.duration =
          distanceInPixels < TARGET_SEEK_SCROLL_DISTANCE_PX
              ? (int) (Math.abs(distanceInPixels) * millisPerPx)
              : duration;
    }
